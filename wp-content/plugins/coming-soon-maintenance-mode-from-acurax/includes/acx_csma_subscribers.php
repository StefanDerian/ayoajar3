...
{	
	...
	$acx_csma_message = "EMAIL Deleted Successfully!.";
}	
$acx_csma_subscribe_details=get_option('acx_csma_subscribe_user_details');
	if(is_serialized($acx_csma_subscribe_details ))
	{
...
<div class="main_wrap">
<?php
 echo "<h2>" . __( 'Maintenance Mode Subscribers', 'acx_csma_config' ) . "</h2>";
...
jQuery( document ).ready(function() {
 var new_button="<a onclick='acx_csma_subscribe_list();' class='button'>Export Current Subscribers</a>";
