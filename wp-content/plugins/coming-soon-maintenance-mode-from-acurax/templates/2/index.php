...
?>
					...
					<div class="timer_box days"> 
						<ul>
							...
							<li class="day_text" style="color:<?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_timer_head_color2']; ?>">Days</li>
						</ul>
					</div><!-- timer_box -->
					<div class="timer_box"> 
						<ul>
						...
						<p style="color:<?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_timer_head_color2']; ?>">Hours</p>
					</div><!-- timer_box -->	
					<div class="timer_box"> 
						<ul>
						...
						<p style="color:<?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_timer_head_color2']; ?>">Minutes</p>						
					</div><!-- timer_box -->
				...
				<?php } ?>
					...
					<h4 style="color:<?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_desc_text_color2']; ?>"><?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_desc_title2']; ?></h4> 
					<p><?php echo $acx_csma_appearence_array_2[$acx_csma_template_id]['acx_csma_desc_subtitle2']; ?></p>
				</div><!-- inline_block -->
			</div><!-- inline_block -->
			<div class="footer"> 
			<?php
