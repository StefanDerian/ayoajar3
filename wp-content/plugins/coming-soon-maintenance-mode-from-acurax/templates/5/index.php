...
?>
	<div class="wrapper <?php echo $new_class; ?>"> 
		<div class="canvas1000"> 
			...
			{?>
				<div class="logo_text" style="color:<?php  echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_logo_text_color5']; ?>"><?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_logo_text5']; ?></div>
				<?php } } ?>
			</div><!-- header -->	
			<div class="inline_block mg_top" style="background:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_inside_bg_color5']; ?>"> 
				<h2 style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_title_color5']; ?>"><?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_title5']; ?></h2>
	...
	<!-- Start: The Countdown -->
		...
		<ul id="countdown" class="count_down">
			...
			<div class="textWeeks" id="names" style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_timer_head_color5']; ?>">Weeks</div>
			</li>
			...
			<div class="textDays" id="names" style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_timer_head_color5']; ?>">Days</div>
			</li>
			...
			<div class="textHours" id="names" style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_timer_head_color5']; ?>">Hours</div>
			</li>
			...
			<div class="textMinutes" id="names" style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_timer_head_color5']; ?>">Minutes</div>
			</li>
			...
			<div class="textSeconds" id="names" style="color:<?php echo $acx_csma_appearence_array_5[$acx_csma_template_id]['acx_csma_timer_head_color5']; ?>">Seconds</div>
			</li>
