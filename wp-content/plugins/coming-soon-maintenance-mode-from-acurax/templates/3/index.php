...
<div class="acx_aditnl_wrap" style="background-color:<?php echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_secondary_color3']; ?>;">	
		<div class="canvas960"> 
			...
			<?php } else if($acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_logo_choice']=="text"){?>
				<div class="logo_text" style="color:<?php  echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_logo_text_color3']; ?>"><?php echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_logo_text3']; ?></div>
					<?php } } ?>
					</div><!-- header  -->
					<div class="form"> 
			...
			{		
				?>
					...
					<div class="timer_box"> 
						...
						<p style="color:<?php echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_timer_head_color3']; ?>">Hours</p>
					</div><!-- timer_box -->	
					<div class="timer_box"> 
						<ul style="color:<?php echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_timer_iptext_color3']; ?>">
						...
						<p style="color:<?php echo $acx_csma_appearence_array_3[$acx_csma_template_id]['acx_csma_timer_head_color3']; ?>">Minutes</p>						
					</div><!-- timer_box -->
