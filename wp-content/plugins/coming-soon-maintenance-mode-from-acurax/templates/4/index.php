...
<div class="wrapper <?php echo $new_class; ?>"> 
		<div class="canvas1000"> 
			...
			<?php } else if($acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_logo_choice']=="text"){?>
				<div class="logo_text" style="color:<?php  echo $acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_logo_text_color4']; ?>"><?php echo $acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_logo_text4']; ?></div>
			<?php } } ?>
			</div><!-- header -->	
			<div class="inline_block mg_top" style="background: none repeat scroll 0 0 <?php echo $acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_inside_bg_color4']; ?>"> 
				<h2 style="color:<?php echo $acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_title_color4']; ?>"><?php echo $acx_csma_appearence_array_4[$acx_csma_template_id]['acx_csma_title4']; ?></h2>
